...
| `shouldSkip`           | (allValues, direction) => stepValues | ❌       |         | Function that returns boolean telling whether the step should be skipped or not.<br /><br /><b>Params:</b><br />- `allValues`: all form field values from previous steps<br />- `direction`: TODO                                                                         |
